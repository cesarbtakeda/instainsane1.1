#!/bin/bash
# Coded by: cesarbtakeda (Don't change, noob!)
# https://www.github.com/cesarbtakeda
...
printf "\n"
printf "\e[1;77m\e[41m  Instagram Brute Forcer v1.1, Author: @cearbtakeda (Github/IG)  \e[0m\n" #Don't change, noob
printf "\n"
}
